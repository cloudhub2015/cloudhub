...
public final class UserMeta extends org.slim3.datastore.ModelMeta<sample.model.User> {
    ...
    /** */
    public UserMeta() {
        super("User", sample.model.User.class);
    }
    ...
    @Override
    protected sample.model.User jsonToModel(org.slim3.datastore.json.JsonRootReader rootReader, int maxDepth, int currentDepth) {
