...
<!DOCTYPE html>
<html lang="en" ng-app="updateTodaysTask">
<head>
    ...
    <div class="col s12 m9 l10">
      <div id="right" class="section scrollspy">
        ...
        <table class="unfinished_tasks">
          <tbody ng-controller="updateTodaysTaskCtrl">
            <tr>
              <td><b>Task Name</b></td>
              <td ng-model="taskName">{{currentTask.taskName}}</td>
            </tr>

            <tr>
              <td><b>Phase</b></td>
              <td ng-model="phase">{{currentTask.phase}}</td>
            </tr>
            ...
            <tr>
              ...
              <td>
                ...
                <input id="task_name" type="text" class="validate" value="{{ currentTask.spentHours }}" ng-model="spentHours">     
                </div>
              </div>
            </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <div class="row">
                    <div class="col s6">
                      <select class="browser-default" ng-model="status">
