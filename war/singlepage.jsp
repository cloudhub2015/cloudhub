...
* 0.0.8 - September 15, 2015	   - Janna Tapitha S. Pedrano  - Set list using AngularJS with active links
-->
...
<ul id="nav-mobile" class="side-nav fixed" style="left: 0px;">
    ...
    <li ng-class="{active: $route.current.activetab == 'tasks'}"><a href="#/tasks">Masterlist</a></li>
    <li ng-class="{active: $route.current.activetab == 'tasks/completed'}"><a href="#/tasks/completed">Completed Tasks</a></li>
    <li ng-class="{active: $route.current.activetab == 'tasks/today'}"><a href="#/tasks/today" class="waves-effect waves-teal">Pending Tasks</a></li>
    <li ng-class="{active: $route.current.activetab == 'tasks/add'}"><a href="#/tasks/add" class="waves-effect waves-teal">Create Task</a></li>
    <li ng-class="{active: $route.current.activetab == 'user/settings'}"><a href="#/user/settings" class="waves-effect waves-teal">Settings</a></li>
    <li><a href="/" class="waves-effect waves-teal">Log Out </a></li>
</ul>
</header>
