...
<title>taskinformation AddTaskInformation</title>
</head>
<body>
<p>Hello taskinformation AddTaskInformation !!!</p>
</body>
</html>
-->
...
<ul id="nav-mobile" class="side-nav fixed" style="left: 0px;">
    ...
    <li class="bold"><a href="home.html" class="waves-effect waves-teal">Masterlist</a></li>
    <li class="bold"><a href="todays_tasks.html" class="waves-effect waves-teal">Today's Tasks</a></li>
